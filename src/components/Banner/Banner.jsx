...
const Banner = () => {
    return (
        <div className="text-center mt-9 mb-16 md:mb-24">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-center md:justify-center">
                <button className="rounded-[50px] bg-[#0BE58A] text-[#150B2B] text-base md:text-xl font-semibold py-4 px-4 md:px-6 w-4/5 md:w-fit">Explore Now</button>
                <button className="rounded-[50px] text-white border border-white text-base md:text-xl font-semibold py-4 px-4 md:px-6 w-4/5 md:w-fit">Our Feedback</button>
            </div>
         </div>
        </div>
    );
